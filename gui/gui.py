...
class GUI:
    ...
    def update_buffer(self):
        for gui_b, b in zip_longest(self.gui_buffers, self.app.put_disp.buffers):
            if b:
    ...
    def update_instruments(self):
        for gui_i, i in zip(self.gui_instruments, self.app.instruments):
            if i.is_busy:
    ...
    def update_refuse(self):
        q = self.app.put_disp.refused_query
        if q:
